...
# xxx = seq(t2+t3, (pi+t2+t3)/2, length.out = 7)
# 
# R =  future_lapply(xxx, FUN = computeR_t1, future.seed = FALSE)
# little_power = future_lapply(xxx, FUN = little_power_t1, future.seed = FALSE)
# little_power_cov = future_lapply(xxx, FUN = little_power_cov_t1, future.seed = FALSE)
# our_power = future_lapply(xxx, FUN = bootstrap_power_t1, future.seed = FALSE)
# 
# end.time = Sys.time()
# time.taken = round(end.time - start.time, 2)
# time.taken
