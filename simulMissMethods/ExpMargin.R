...
generate_data_MAR1 <- function(p, x = NULL) {
  delete_MAR_rank(data, p, c(1, 2), cols_ctrl = c(3, 3))
}

generate_data_MAR2 <- function(p, x) {
  delete_MAR_1_to_x(data, p, c(1, 2), cols_ctrl = c(3, 3), x = x)
}
...
#----------------------------------------------------------------------------------------
# Run simulations for d = 3 and exponential data
#----------------------------------------------------------------------------------------
d = 3
for (yyy in c("exp")){
  #----------------------------------------------------------------------------------------
